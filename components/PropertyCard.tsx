  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        {/* Property Type Badge */}
        <div className="absolute top-4 right-4 bg-ocean-500 text-white px-4 py-2 rounded-lg font-semibold">
          {property.propertyTypeHe}
        </div>

        {/* ROI Badge */}
        <div className="absolute top-4 left-4 bg-gold-500 text-white px-3 py-1 rounded-lg text-sm font-semibold flex items-center gap-1">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-3">
          ...
          <span className="text-sm">{property.location.cityHe}, {property.location.areaHe}</span>
        </div>

        {/* Title */}
        <h3 className="text-2xl font-display font-bold mb-3 line-clamp-2">
          {property.titleHe}
        </h3>
