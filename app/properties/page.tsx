...
export const metadata: Metadata = {
  title: 'מאמרים על נדל"ן בקפריסין | Cyprus Insights',
  description:
    'מדריכים מקצועיים, ניתוחי שוק, וטיפים להשקעה בנדל"ן בקפריסין למשקיעים ישראלים',
};

// פונקציה לשליפת מאמרים מהשרת
...
export default async function ArticlesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      {/* Hero Section */}
      <section className="luxury-gradient text-white section-padding">
        <div className="container-custom text-center">
          <h1 className="text-5xl font-bold mb-6">מאמרים ומדריכים</h1>
          <p className="text-xl max-w-3xl mx-auto">
            מידע מקצועי ועדכני עבור משקיעים חכמים בנדל״ן קפריסאי
          </p>
        </div>
      </section>
